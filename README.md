# AI 辅助评审系统（smart-procurement）

> **面向政府采购评标场景的一站式 AI 辅助评审平台**：从投标受理、围串标风控、专家智能匹配与利益冲突回避，到 AI 辅助打分、评标汇总与定标归档，全链路数字化、可审计、可降级。
...
政府采购/招标评标是**高合规要求、高人工成本、高风险**的业务：
